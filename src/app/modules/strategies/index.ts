...
const _smaEmaCrossover = async (): Promise<StrategyResult> => {
  const symbol = ENV.INDODAX_PAIR;
  const tf = ENV.INDODAX_TIMEFRAME_MIN;
...
const _rsiMomentum = async (): Promise<StrategyResult> => {
  const symbol = ENV.INDODAX_PAIR;
  const tf = ENV.INDODAX_TIMEFRAME_MIN;
...
const _scalping = async (): Promise<StrategyResult> => {
  const symbol = ENV.INDODAX_PAIR;
  const tf = ENV.INDODAX_TIMEFRAME_MIN;
...
const _swingDayTrading = async (): Promise<StrategyResult> => {
  const symbol = ENV.INDODAX_PAIR;
  const tf = ENV.INDODAX_TIMEFRAME_MIN;
...
const _trendFollowing = async (): Promise<StrategyResult> => {
  const symbol = ENV.INDODAX_PAIR;
  const tf = ENV.INDODAX_TIMEFRAME_MIN;
...
const _rangeReversal = async (): Promise<StrategyResult> => {
  const symbol = ENV.INDODAX_PAIR;
  const tf = ENV.INDODAX_TIMEFRAME_MIN;
...
const _statArb = async (): Promise<StrategyResult> => {
  const symbol = ENV.INDODAX_PAIR;
  const tf = ENV.INDODAX_TIMEFRAME_MIN;
...
const _meanReversion = async (): Promise<StrategyResult> => {
  const symbol = ENV.INDODAX_PAIR;
  const tf = ENV.INDODAX_TIMEFRAME_MIN;
  const sma20 = await getIndicatorSeries(symbol, tf, 'sma20', 20);
...
const _dynamicGrid = async (): Promise<StrategyResult> => {
  const symbol = ENV.INDODAX_PAIR;
  const tf = ENV.INDODAX_TIMEFRAME_MIN;
...
export const runStrategies = async (): Promise<StrategyResult[]> => {
